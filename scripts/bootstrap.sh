...
# Optional: WMF_TAG=v0.3.0 to pin a release
# Optional: WMF_SKIP_MIMIC=1 to skip mimic apt install
set -euo pipefail
...
if [[ "$(id -u)" -eq 0 ]]; then
    ...
    echo "请运行：sudo bash install.sh install-all"
fi
